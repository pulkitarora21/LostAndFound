<?php
/**
 * The index page for lost items.
 *
 * This page displays all of the lost items from the database.
 *
 * @package lost
 */
/**
...
$total=count( $template->allLostItems );
...
?>
    ...
    <div id="items">
        <table class="searchStyle" cellpadding="10px" >
            ...
            <?php
$items = $template->allLostItems;
$limit= $page==$last?$total:$page*$pageSize;
for ( $i=( $page-1 )*$pageSize;$i<$limit;$i++ ) {
    echo "<tr>";
    echo '<td><a href="lost/'.$items[$i]["id"].'"><img src="'.IMAGE_URL.$items[$i]['image'].'" alt="image" /></a></td>';
    echo '<td><div id="itemDetail"><b>Name: </b><a href="lost/'.$items[$i]["id"].'">'.$items[$i]["name"].'</a><br/>';
